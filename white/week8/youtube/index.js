...
const fetchVideo = () => {
    ...
    fetch(
        "https://youtube.googleapis.com/youtube/v3/videos?part=snippet&part=statistics&chart=mostPopular&maxResults=100&regionCode=kr&key=AIzaSyBMk4TmjSrFMXDyDOgUNEmLzBJn5RD-IVY",
        requestOptions
    )
						...
						<a href=${`https://www.youtube.com/watch?v=${data.id}`}>
								<div class="videoMetaDetails">
										...
										<div class="videoMetaData">
												...
												<p class="extraMeta">
														<span class="metaText viewCount">${Number(data.statistics.viewCount) > 100000
            ? (
