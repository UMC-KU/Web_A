...
const API_KEY='AIzaSyDOWr2niJdUJE-PHcTbSsR2GmoouOioh48'
function fetchData()
{
    fetch(`GET https://youtube.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&maxResults=100&regionCode=kr&key=${API_KEY}`)
